import HautevilleHouse.FiniteAffineProjectivePlanesGeometricCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "manifold-constrained theorem certificate internalized through baseline constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
